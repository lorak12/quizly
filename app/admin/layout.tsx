...
function AdminLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    ...
    >
      <div className="fixed inset-y-0 left-0 z-10 flex-col border-r bg-background sm:flex mt-[67px] w-[200px] hidden">
      ...
      <div className="fixed inset-y-0 left-0 z-10 flex-col border-r bg-background flex mt-[67px] sm:hidden w-[57px]">
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div className="flex-1 mt-4">
